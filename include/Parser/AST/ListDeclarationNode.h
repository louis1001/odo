...
struct ListDeclarationNode final : public Node {
    ...
    ListDeclarationNode(Lexing::Token var_type_p, Lexing::Token name_p, int dim_p, std::shared_ptr<Parsing::Node> initial_p);

    static std::shared_ptr<Node> create(Lexing::Token var_type_p, Lexing::Token name_p, int dim_p, std::shared_ptr<Parsing::Node> initial_p){
